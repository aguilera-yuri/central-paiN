            ...
            .then(
                function (resultadoAutenticar) {
                    ...
                    if (resultadoAutenticar.length == 1) {
                        ...
                        aquarioModel.buscarAquariosPorEmpresa(resultadoAutenticar[0].idEstado)
...
function cadastrar(req, res) {
    ...
    if (nome == undefined) {
        ...
        usuarioModel.cadastrar(nome, apelido, cpf, email, senha, idEstado)
            .then(
                function (resultado) {
                    res.json(resultado);
                }
